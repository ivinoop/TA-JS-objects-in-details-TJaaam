...
person.displayName.call(person2); // Uncaught ReferenceError: person2 is not defined
...
console.log(getSecondData()); // 1 --> because the first object is bound by the second object, so `this` will point to first object
